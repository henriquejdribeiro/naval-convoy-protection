    ...
    PrimeFieldElement0
{
    ...
    // Canonical mainnet layout 6 (starknet): 8 builtins in the
    // bootloader output (output, pedersen, range_check, ecdsa,
    // bitwise, ec_op, keccak, poseidon). Matches the 718-felt
    // bootloader at vendor/cairo-bootloader/resources/bootloader-0.13.0.json
    // and the canonical CpuConstraintPoly AIR.
