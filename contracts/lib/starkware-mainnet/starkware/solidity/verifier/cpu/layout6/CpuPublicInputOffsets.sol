...
contract CpuPublicInputOffsets is CpuPublicInputOffsetsBase {
    ...
    uint256 internal constant OFFSET_KECCAK_BEGIN_ADDR = 20;
    uint256 internal constant OFFSET_KECCAK_STOP_PTR = 21;
    uint256 internal constant OFFSET_POSEIDON_BEGIN_ADDR = 22;
    uint256 internal constant OFFSET_POSEIDON_STOP_PTR = 23;
    uint256 internal constant OFFSET_PUBLIC_MEMORY_PADDING_ADDR = 24;
    uint256 internal constant OFFSET_PUBLIC_MEMORY_PADDING_VALUE = 25;
    uint256 internal constant OFFSET_N_PUBLIC_MEMORY_PAGES = 26;
    uint256 internal constant OFFSET_PUBLIC_MEMORY = 27;
}
