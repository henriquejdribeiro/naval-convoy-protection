...
abstract contract LayoutSpecific is MemoryMap, StarkParameters, CpuPublicInputOffsets, CairoVerifierContract {
    ...
    function getLayoutInfo()
        ...
        // Canonical mainnet layout 6 ("starknet"): all 8 builtins selected,
        // keccak at bit 6, poseidon at bit 7. The bootloader allocates
        // these in this exact order; the verifier reads slot N for
        // KECCAK_BUILTIN_BIT (= 6) and slot N+1 for POSEIDON_BUILTIN_BIT
        // (= 7). CpuConstraintPoly evaluates the AIR constraints with
        // these positions assumed. Stone with --layout=starknet produces
        // proofs against this exact configuration.
        selectedBuiltins =
