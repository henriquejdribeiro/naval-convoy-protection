// =============================================================================
// safe_area_verify_alpha.cairo — per-SWARM coverage proof, ALPHA (green zone)
// =============================================================================
// ONE STARK proof for the whole 5-drone alpha swarm. The swarm leader (a1) runs
// this over all 5 drones' L2-signed telemetry and produces a single proof, which
// the alpha relay ship (ship-f) submits to the L1 Verifier.
//
// ALPHA sensor class — BAKED INTO THIS PROGRAM'S HASH (the whole point of having
// two programs): each reading is a 0.1° square footprint (SENSOR_HALF = 0.05°),
// clearing exactly 1 of the zone's 0.1° blocks. Green zone = 1°×1° = 100 blocks;
// each of the 5 drones owns a 0.2°-wide strip = 20 blocks.
//
